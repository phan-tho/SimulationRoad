...
Nếu file này có gì thiếu sót, khó hiểu. Đề nghị bổ sung, góp ý, commit
...
### Logic:
main.py với folder simulation lắng nghe chỉ đạo của cái thằng simple_controller
...
* file `dacta_dieukhien.txt`: yêu cầu và hướng dẫn cho phần mềm điều khiển (cần đọc qua để sau biết cần code điều khiển như nào, plug in cái demo như nào)
